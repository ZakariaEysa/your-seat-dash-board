...
import 'logo_promo_version .dart';
...
class MovieInfoScreenState extends State<MovieInfoScreen> {
  ...
  void initState() {
    ...
    selectedGenre =
        genreOptions.contains(movie['genre']) ? movie['genre'] : null;
    selectedLanguage =
        languageOptions.contains(movie['language']) ? movie['language'] : null;
    selectedStatus =
        statusOptions.contains(movie['status']) ? movie['status'] : null;
    selectedCensorship = censorshipOptions.contains(movie['censorship'])
        ? movie['censorship']
        : null;
  }
  ...
  bool validateFields() {
    setState(() {
      ...
      _durationError =
          Validators.validateDurationFormat(_durationController.text);
      _movieGenreError =
      ...
      _promoLinkError =
          Validators.validateYouTubeLink(_promoLinkController.text);
              ...
              children: [
                Row(
                  ...
                  children: [
                              ...
                              Expanded(
                                child: MovieTextFieldLabel(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      _promoLinkError =
                                          Validators.validateYouTubeLink(
                                        value,
                                      );
                                    });
                                  },
                              ...
                              Expanded(
                                child: MovieTextFieldLabel(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      _versionError =
                                          Validators.validateVersionNumber(value);
                                    });
                                  },
                                ),
                              ),
                    ...
                    Expanded(child:  LogoPromoVersion(
                      ...
                      isViewOnly: false, // أو true لو عايز تخليه قراءة فقط
                    ),
                    )
                  ],
                ),
